...
include "config-login.php";
 ...
 {
    $customer_email = mysqli_real_escape_string($con,$_POST['id_check']);


    $sql = "SELECT b.reservation_id, c.fname, c.lname,  b.reservation_date, b.pickup_date, b.return_date, b.pickup_location, ca.model_name, b.license_plate
    FROM booking_details b NATURAL JOIN car ca NATURAL JOIN customer c WHERE c.email = '$customer_email'";
